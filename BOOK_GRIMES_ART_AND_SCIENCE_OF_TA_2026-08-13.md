...
| 4 | Match the trade to the market regime. | The gate IS the regime switch, mechanically: when the tape changes, a setup's trailing record opens or closes it — no human in the loop, no hand-flipped env. | **Measured at birth** (trailing 120d): keltner n=106 **+$48.79 t=0.75 → OPEN**; pullback n=130 −$13.32 → closed; failtest n=294 −$7.24 → closed. The book is born trading exactly one setup, by its own rule — the recent tape favors mean reversion and the gate found that without being told. |
