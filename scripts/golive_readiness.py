...
DECIDED_UNTIL = {
    ...
    "perps-funding-spread": (
        ...
        "on-class closes after 1-Sep -- CLOSED-after, declared at (zt) and "
        "pinned by scripts/study_counterweight_fresh_read_2026-09-10.py "
        "after two sessions read the basis differently (n=13 opened vs "
        "n=21 closed) -- or on 10-Oct ((zs): 1-Oct moved on Eamon's call; "
        "thresholds untouched), whichever first: RETIRE "
