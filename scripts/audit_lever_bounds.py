...
CONSUMERS = {
    ...
    "barnes.enter_apr": ("lighter_band_barnes_bot.py", "BARNES_ENTER_APR"),
    "barnes.max_positions": ("lighter_band_barnes_bot.py",
                             "BARNES_MAX_POSITIONS"),
    "barnes.k": ("lighter_band_barnes_bot.py", "BARNES_K"),
