...
FUNDING_BOOKS = [
    ...
    # 🛢️ band-garrett-lshadow RETIRED 2-Sep (wt) — n=85, t=-2.22, upper
    ...
    # (wt) — both rows leave the rivalry counts (the (pm) reason).
...
KNOWN_CELL_COLLISIONS = {
    ...
    # [2026-09-02 (wt)] THE CARRY/GARRETT COMPONENT IS GONE: 🛢️ Garrett is
