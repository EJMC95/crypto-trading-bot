...
CARRIED = [
    ...
    },
    {
        ...
        "what": "EDGE_AUDIT_2026-09-02.md section 6.1 pre-registered a keep-or-"
                ...
                "[9-Sep (zi)] RE-TAKEN, against this row's own "
                "instruction not to, and THE VERDICT DID NOT MOVE -- "
                "recorded so a third session does not spend the same "
                "hour. Fresh n=275, mean -0.065%/trade, SE 0.116, "
                "t -0.56, upper bound +0.083%: still no exclusion, "
                "still not positive, still returns to Eamon. Tail "
                "dominance held (top-3 = +18.68pp of a -17.81pp "
                "total; ex-top-3 fresh mean -0.134%). ONE NEW FACT, "
                "AND IT IS A TRAP: the ALL-TIME sample (n=631, mean "
                "-0.145%, t -1.35) now carries an upper bound of "
                "-0.008% -- it has crossed zero for the first time. "
                "That is NOT a retirement trigger here: the "
                "registered rule is on the FRESH sample by "
                "construction, and retiring on the pooled window is "
                "exactly the re-mining I21 forbids (the pooled "
                "window CONTAINS the stretch that motivated the "
                "concern). It is reported, never acted on.",
        "why_open": "the READ is done; the DECISION is Eamon's and has not been "
                    ...
                    "-- it has now been taken TWICE, 7-Sep and 9-Sep, and "
                    "moved nothing; and do NOT retire on the all-time "
                    "upper bound, which crossed zero on 9-Sep and is the "
                    "wrong sample by the registration's own terms. "
