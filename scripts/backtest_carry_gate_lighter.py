...
MAX_POSITIONS/PERSIST_H/FLIP_GRACE_H from the bot (see the (he)/(qk) notes
...
# [2026-08-18 (qk)] PERSIST_H AND FLIP_GRACE_H WERE THE SAME (he) CLASS, TWO
# LINES DOWN FROM ITS FIX. Both were retyped literals: the bot moved
# FLIP_GRACE_H 1h->6h at (px) and PERSIST_H 6h->12h at (qk), and this harness
