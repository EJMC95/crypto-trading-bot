...
def test_the_fixtures_carry_the_publishers_own_keys():
    ...
    # still fails if a key is added, renamed or dropped.
    led = _publisher_dict_keys("normalize_paper_row")
    assert set(_led("x")) == led, (
        "ledger fixture drifted from normalize_paper_row's constructed dict: "
